<?php $__env->startSection('title', 'Edit Beat'); ?>
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="title" placeholder="Title" name="title" value="<?php echo $beat->title; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="slug" class="col-lg-2 control-label">Video Slug</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="slug" placeholder="Slug" name="slug" value="<?php echo $beat->video_slug; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea class="form-control" id="tags" name="tags" value=""><?php echo $selectedTags; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select class="form-control" id="setup" name="setup">
                                <?php $__currentLoopData = $setups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo $setup->id; ?>" <?php if($setup->id === $selSetup[0]): ?>
                                            selected="selected" <?php endif; ?>>
                                        <?php echo $setup->name; ?>

                                    </option>
                                    <h1><?php echo var_dump($selSetup); ?></h1>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
